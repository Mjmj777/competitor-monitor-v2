# Competitor Intelligence Monitor v5.13.0
...
After GitHub Actions succeeds, copy the complete `cloudflare-worker.js` from the repository update into the Cloudflare Worker editor and Deploy. `/__session` should then report `worker_build: "5.13.0"`.
